...
$currentUsername = htmlspecialchars(
    (string) $_SESSION["titanCurrentUser"],
    ENT_QUOTES,
    "UTF-8"
);
...
<body>
  ...
  <div class="account-widget" aria-label="Current account">
    <img
    ...
    <section id="programs" aria-labelledby="programs-heading">
      ...
      <div class="program-grid">
        ...
        >
          ...
          <h3>Speed Drills</h3>
          <p>For speedy athletes who want to stay at their best.</p>
        </article>
        ...
        >
          ...
          <p>Football, soccer, basketball, and baseball are all supported.</p>
        </article>
      </div>
    </section>
  </main>
