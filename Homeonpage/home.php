  ...
  <main class="home-card" id="home">
    ...
    <section id="programs" aria-labelledby="programs-heading">
      ...
      <div class="program-grid">
        ...
        <article class="program-card"><span class="program-number" >03</span><h3>Sport-Specific Conditioning</h3><p>Football, soccer, basketball, and baseball are all supported.</p></article>
      </div>
    </section>
  </main>
